      ...
      >
        <div className="flex justify-center mb-6">
          <div className="flex items-center">
            <FiShield className="text-green-500 mr-2" size={20} />
            <h1 className="text-2xl font-bold text-white">PHANTOM<span className="text-green-500">HUB</span></h1>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <button 
              type="submit"
              className="w-full flex items-center justify-center py-2 px-4 bg-green-500/10 text-green-500 border border-green-500/30 rounded hover:bg-green-500/20 transition-colors mt-6"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
